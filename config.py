...
YT_API_KEY = getenv("YT_API_KEY", None)  # Your API key from https://t.me/tgmusic_apibot
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/KRISHXSTARCODER/KrishXStar-DevZone.git",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)  # Fill if your upstream repository is private
